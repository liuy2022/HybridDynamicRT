function [pixel_distance_vector,distan_all_array,amplitude_all] = fun_hybrid_load_scattering_Blender_file(pixel_width,pixel_height,frame_start,frame_end,num_tx,num_rx,path_load)
%
...
for frame_index= frame_start: 1:(frame_end)
     for index_tx = 1:num_tx
        for index_rx = 1: num_rx
            ...
            % Z-path 
            raw_data_blender_Dist =   2*exrread(char(path_load + "Tx" + num2str(1-1) + "Rx" + num2str(1-1) + "/Depth" + num2str((frame_index),'%04d')+".exr"));
